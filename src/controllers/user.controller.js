...
const loginUser = asyncHandler(async (req, res) => {
  ...
  //check if email is  and password are empty or not
  //check if email and password exist ..remember that we have stored password in hashed form if it already exists.
